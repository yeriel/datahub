  ...
  return {
    ...
    hooks: {
      ...
      "astro:build:done": async () => {
        try {
          console.log("[prebuild-navigation] Build completed - navigation was prebuilt during page generation");
          ...
          if (outDir) {
            ...
            try {
              ...
              console.warn("[prebuild-navigation] Note: Nav directory not created (may be normal for dev builds)");
            }
          }
        } catch (error) {
          console.error(
