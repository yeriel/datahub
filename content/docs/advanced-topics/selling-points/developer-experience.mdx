...
- **Tailwind + Biome** keep styling and source formatting consistent with one fast toolchain.
...
- Run `pnpm validate` and `pnpm build` in CI so validation protects main.
